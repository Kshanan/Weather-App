...
def default():
    ...
    result['text']=format_response(weather)    #Result received after interpreting the API data
                                              #Making a copy of result to store in Excel Sheet
...
def format_response(weather):   
    try:      
        ...
        final_str =messagebox.showwarning('showwarning',"City not found")
    return final_str      
...
info=tk.Label(bg_lbl,text='Project by Kshanan Muttin',fg='cyan',bg='black',font=('Brush Script MT',12))
info.place(x=320,y=355)

img3=Image.open('./hy.png')
img3=img3.resize((60,25),Image.ANTIALIAS)    
img4=ImageTk.PhotoImage(img3)
btn2=tk.Button(root,image=img4,borderwidth=0)
